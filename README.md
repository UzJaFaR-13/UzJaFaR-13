...
[![My Skills](https://skillicons.dev/icons?i=docker,vim,js,vite,redis,redhat,postgres,pinia,symfony,react,vue,ae,arch,bash,bootstrap,css,figma,git,github,gitlab,gmail,gulp,html,htmx,ai,jest,kali,linux,mysql,netlify,nodejs,npm,ps,php,phpstorm,powershell,pr,sass,stackoverflow,ubuntu,&perline=15)](https://skillicons.dev)
